 ...
 * tiltle : meeting scheduling , it is an individual module can run individualy.
 */
...
//			       String startd = date_format.format(date.getText());
	...
	// clear all content that exist inn box
		...
		btnClear.setBounds(273, 638, 168, 50);
